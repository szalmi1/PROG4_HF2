...
namespace CarRental.MVC
{
    ...
    public class Factory : IDisposable
    {
        ...
        public Factory()
        {
            this.ctx = new RentalContext();
            OwnerRepository ownerRepo = new OwnerRepository(this.ctx);
            CarRepository carRepo = new CarRepository(this.ctx);
            ContractorRepository contractorRepo = new ContractorRepository(this.ctx);
            RentalRepository rentalRepo = new RentalRepository(this.ctx);
